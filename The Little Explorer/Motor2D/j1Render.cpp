...
{
	BROFILER_CATEGORY("RenderPreUpdate", Profiler::Color::Brown)
...
{	
	BROFILER_CATEGORY("RenderUpdate", Profiler::Color::Brown)
	return true;
}

bool j1Render::PostUpdate()
{
	BROFILER_CATEGORY("RenderPostUpdate", Profiler::Color::Brown)
