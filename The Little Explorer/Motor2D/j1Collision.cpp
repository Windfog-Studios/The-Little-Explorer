...
j1Collision::j1Collision()
{
	...
	matrix[COLLIDER_DEATH][COLLIDER_COLLECTIBLE] = false;
	...
	matrix[COLLIDER_PLATFORM][COLLIDER_COLLECTIBLE] = false;
	...
	matrix[TRIGGER][COLLIDER_COLLECTIBLE] = false;
	...
	matrix[COLLIDER_PLAYER_ATTACK][COLLIDER_COLLECTIBLE] = false;

	matrix[COLLIDER_COLLECTIBLE][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_COLLECTIBLE][TRIGGER] = false;
	matrix[COLLIDER_COLLECTIBLE][COLLIDER_DEATH] = false;
	matrix[COLLIDER_COLLECTIBLE][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_COLLECTIBLE][COLLIDER_PLATFORM] = false;
	matrix[COLLIDER_COLLECTIBLE][COLLIDER_PLAYER_ATTACK] = false;
